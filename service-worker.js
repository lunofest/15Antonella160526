const CACHE_NAME = 'cache-v78'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v78',
    'estilos/styles.css?v78',
    'estilos/mediaQueries.css?v78',
    'javascript/script.js?v78',
